namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrProcess_b0e6b3bMethodsWrapper

	/// <exclude/>
	public class UsrProcess_b0e6b3bMethodsWrapper : ProcessModel
	{

		public UsrProcess_b0e6b3bMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			Guid offerTypeId = Get<Guid>("RealtyOfferTypeIdParametar");
