		...
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"tools": [],
					"items": [],
					"title": "#ResourceString(ExpansionPanel_k3tzcvq_title)#",
					"toggleType": "default",
					"togglePosition": "before",
					"expanded": true,
					"labelColor": "auto",
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(GridDetailRefreshBtn_13mpn9k_caption)#",
					"icon": "reload-icon",
					"iconPosition": "only-icon",
					"color": "default",
					"size": "medium",
			...
			},
			{
				...
				"values": {
					...
					"_filterOptions": {
						"expose": [
							{
								"attribute": "GridDetailSearchFilter_jkhnmz5_GrantedOperationsGridDetail",
								"converters": [
									{
										"converter": "crt.SearchFilterAttributeConverter",
										"args": [
											"GrantedOperationsGridDetail"
										]
									}
								]
							}
